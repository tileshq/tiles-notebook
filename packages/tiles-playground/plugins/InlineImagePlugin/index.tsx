...
// Create a function to get the transparent image element only in browser environment
function getTransparentImageElement(): HTMLImageElement | null {
...
function $onDragStart(event: DragEvent): boolean {
  ...
  // Only set drag image if we're in a browser environment
  const img = getTransparentImageElement();
  if (img) {
