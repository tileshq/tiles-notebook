...
import {INITIAL_SETTINGS, isDevPlayground} from '@/utils/appSettings';
      ...
      {showSettings ? (
        <div className="switches">
          ...
          {isDevPlayground && (
            <Switch
              onClick={() => {
                if (isSplitScreen && parentWindow) {
                  parentWindow.location.href = `/${search}`;
                } else {
